...
```javascript
import order from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-order@v0.1.0-esm/index.mjs';
```
...
[@stdlib/ndarray/orders]: https://github.com/stdlib-js/stdlib/tree/esm
